...
-- Add this right below the budgets table, before the final index:
CREATE TABLE ai_insights (
    id SERIAL PRIMARY KEY,
    user_id INT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    insight_text TEXT NOT NULL,
    type VARCHAR(20), -- e.g., 'spending_alert', 'budget_recommendation'
    created_at TIMESTAMPTZ DEFAULT NOW()
);

-- This is your existing index line that was crashing:
