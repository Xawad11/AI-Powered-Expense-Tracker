...
const Insights = () => {
    ...
    const stats = useMemo(() => {
        const latestMonthly = insights.find((i) => i.type === 'monthly_summary');
        const latestTips = insights.find((i) => i.type === 'savings_tips');
        const monthly = latestMonthly?.insight_text
        const tips = latestTips?.insight_text
